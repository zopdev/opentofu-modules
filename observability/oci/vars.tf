...
variable "provider_id" {
  description = "Compartment ID of the provider"
  type        = string
}
...
variable "access_key" {
  description = "OCI customer secrets access key to access the S3 storage buckets"
  type        = string
}

variable "access_secret" {
  description = "OCI customer secrets access secret to access the S3 storage buckets"
  type        = string
}
