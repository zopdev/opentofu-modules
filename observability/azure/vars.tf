...
variable "app_region" {
  description = "Cloud region to deploy to (e.g. eastus)"
  type        = string
}
...
variable "storage_account" {
  description = "The Azure Storage Account name in which data should be stored."
  type        = string
  default     = ""
}

variable "account_access_key" {
  description = "Storage account access key to access the storage container"
  type        = string
}
