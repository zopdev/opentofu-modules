...
module "service_deployment" {
  ...
  app_secrets = (try(each.value.db_name, null) != null || try(each.value.custom_secrets, null) != null || (lookup(local.sql_config_list, each.key, null) != null && try(lookup(local.sql_config_list[each.key], "db_name", null), null) != null)) ? ["${each.key}-application-secrets"] : []
