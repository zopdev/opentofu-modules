...
module "service_deployment" {
  ...
  app_secrets = ( each.value.db_name != null || each.value.custom_secrets != null || (local.sql_config_list[each.key] != null && local.sql_config_list[each.key].db_name != null)) ? ["${each.key}-application-secrets"] : []  
