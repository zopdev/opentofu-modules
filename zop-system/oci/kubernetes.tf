...
module "remote_state_gcp_cluster" {
  ...
  count          = var.cluster_ca_cert == null ? (var.shared_services.type == "gcp" ? 1 : 0) : 0
...
module "remote_state_aws_cluster" {
  ...
  count          = var.cluster_ca_cert == null ? (var.shared_services.type == "aws" ? 1 : 0) : 0
  bucket_name    = var.shared_services.bucket
...
module "remote_state_azure_cluster" {
  ...
  count           = var.cluster_ca_cert == null ? (var.shared_services.type == "azure" ? 1 : 0) : 0
